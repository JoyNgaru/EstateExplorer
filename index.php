                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We make it easy for sellers to post properties they are selling to reach buyers who are looking to buy properties without a hussle. We provide a platform for buyers to meet sellers and purchase their dream homes. Talk about making dreams come true!</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Do you have a property you are letting, we provide you with an arena to meet millions of people looking for rental houses. Post your houses for rent and let people cruise through your ad to choose what best fits their wants. </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>If you are looking for a place to list your properties, then this is the right place for you. We offer you a platform to show the world what you have and its value. Take advantage of this space and start your journey towards property management!</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>You heard that right! Yes, we give you an opportunity to search and procure your legal investment from the comfort of your home. We give you an investment calculator to know how much to throw in. Start your journey with us today, don't wait for tomorrow!</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>we are the premium marketplace for both buyers and sellers. </p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Top notch services for everyone. Enjoy emmersing yourself</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Legit agents to help you out and who post real pictures.</p>
									</div>
                                </li>
                            </ul>
                        </div>
